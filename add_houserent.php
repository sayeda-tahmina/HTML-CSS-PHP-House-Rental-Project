              ...
              House Address
                ...
                <div class="rent">
                  ...
                  <div id="price_tab">
                    ...
                    <div id="fixed">
                      <label for="amount_fixed" style="font-weight:bold;color:coral;">TK </label>
                ...
                Size of house in sq. ft
                  <input type="text" class="form-control" name="sizehouse" placeholder="Size of house in sq. ft">
                </div>
                <div class="dinning">
                Dinning room

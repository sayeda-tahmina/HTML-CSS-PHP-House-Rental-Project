      ...
      <div class="house_details col-sm-4">
        <div class="house_details_inner">
          <table>
            ...
            <tr>
              <td> <strong>Size of House in sq. ft:</strong> </td>
              <td> <?php echo $house['sizehouse']; ?> </td>
            </tr>
            <tr>
      ...
      <div class="action_area col-sm-2">
        <div class="action_main">
            ...
            <div class="single_action">
              ...
              <?php } else { ?>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                  Booked request<span style="margin-left:5px;" class="badge badge-light"><?php if (is_array($total_req)) {
                                                                                            echo count($total_req);
                                                                                          } ?></span>
                </button>
              <?php } ?>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-header">
                      ...
                      <h1><?php echo 'House ID: ' . $houseid; ?></h1>
          ...
          <?php if (Session::get('user') == 'tenant') { ?>
            ...
            <div class="single_action">
              <a class="btn btn-info" href="index.php#contact">Contact us</a>
            </div>
          <?php } else if (!Session::get('user') == 'owner') { ?>

            <div class="single_action">
              <a class="btn btn-info" onclick="loginpage(<?php echo $house['id']; ?>);">Contact us</a>
            </div>
          <?php } ?>
          <script>

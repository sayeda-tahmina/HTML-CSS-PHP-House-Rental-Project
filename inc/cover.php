<div class="cover_area">
  ...
  <div class="cover_main container">
    <div class="cover_inner">
      <div class="title">
        <h1 class="text-center">Find Your Dream Space</h1>
      </div>
      <div class="search_area">
        <div class="search_main">
          <form class="search_cover" action="availablehouse.php" method="get">
            <div class="address_cover">
              <input type="text" name="address" class="form-control" value="" placeholder="Address" required="true">
            </div>
            <div class="rent_type">
                <select class="form-control" style="background-color:lavender;" name="house_type" required="true">

...
class Homecontroller extends Basecontroller
{
  ...
  public function getRequesthomeDetailsbyTenant($id)
  {
    $host = "localhost";
    $user = "root";
    $pass = "";
    ...
    $sql = "SELECT tbl_house.id as house_id, tbl_house.owner_id
,tbl_house.tenant_id,tbl_house.address,tbl_house.road_no,tbl_house.house_no,tbl_house.rental_value, tbl_house.house_type,
tbl_house.floor,tbl_house.bedroom,tbl_house.sizehouse,tbl_house.dinning_room,tbl_house.bathroom,tbl_house.kitchen,tbl_house.balconies,
tbl_house.description, tbl_house.active_status,tbl_house.request_status,tbl_house.img_1,tbl_house.img_2,tbl_house.img_2 FROM tbl_house INNER JOIN tbl_rentrequest ON tbl_house.id = tbl_rentrequest.house_id where tbl_rentrequest.tenant_id='$id' and tbl_rentrequest.request_status=1;";
  ...
  {
    $sql = "SELECT id,address,house_type,rental_value,bedroom,sizehouse,bathroom FROM tbl_house WHERE rental_value BETWEEN :min and :max";
  ...
  public function sendrequest($houseid, $ownerid)
  {
    ...
    $sql = "insert into tbl_rentrequest(house_id,tenant_id,owner_id,request_status) values(:house_id,:tenant_id,:owner_id,:request_status)";
    $query = $this->db->link->prepare($sql);
    $query->bindValue(':house_id', $houseid);
    $query->bindValue(':tenant_id', $tenantid);
    $query->bindValue(':owner_id', $ownerid);
    $query->bindValue(':request_status', $request_status);
  ...
  public function acceptrequest($houseid, $tenants_id)
  {
    ...
    $act_stt = 0;
    $sql1 = "update tbl_rentrequest set request_status='$act_stt'  where tenant_id='$tenants_id' and house_id='$houseid'";

          ...
          <div class="profile_nav">
            <ul class="main_profile_nav">
              ...
              <li> <i class="fas fa-angle-double-right"></i> <strong>Description:</strong>
                <p class="text-justify"><?php if (isset($user->description)) echo $user->description; ?></p>
              </li>
            </ul>
      ...
      <div class="right_profile col-sm-9">
        <div class="right_profile_inner">
          <div class="house_main">
            <div class="available_house col-sm-12">
              <h4>Your Current Requested Home List</h4>
              <?php
              $home = new Homecontroller();

              $result = $home->getRequesthomeDetailsbyTenant($id);
              ?>
                  ...
                  <div class="single_house card">
                    <div class="single_house_inner card-body">
                      <div class="house_title">
                        ...
                        <p class="rent">Price : <?php echo $house['rental_value']; ?> TK
                          <br>
                          Bedroom : <?php echo $house['bedroom']; ?>
                          <br>
                          Size of House in sq. ft : <?php echo $house['sizehouse']; ?>
                          <br>
                          Bathroom : <?php echo $house['bathroom']; ?>
                        </p>
                      </div>
                      <div class="house_img">
                      ...
                      <?php
                      if ($house['request_status'] == 1) {
                        $getuser = $home->getUser($house['tenant_id']);
                      ?>
                        <p style="overflow:hidden;">Requested By <a href="" style="font-weight:strong;margin:0px;float:none;border:none;"><?php echo $getuser->fname . ' ' . $getuser->lname; ?></a> </p>
                      <?php
                      } else if (is_array($total_req) && count($total_req) > 0) { ?>

                      <?php } ?>
                      <a href="housedetails.php?house_id=<?php echo $house['house_id']; ?>">Details</a>
                    </div>
                  </div>
        ...
        <div class="right_profile">
          <div class="right_profile_inner">
            <div class="house_main">
              <div class="available_house col-sm-12">
                <h4>Your Current Booked Home List</h4>
